...
<head>
    ...
    <title>Yuk Rasain!</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('build/assets/img/main_logo.png') }}" rel="icon">
    <link href="{{ asset('build/assets/img/main_logo.png') }}" rel="apple-touch-icon">
    ...
    <header id="header" class="header d-flex align-items-center position-relative">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <img src="{{ asset('build/assets/img/main_logo.png') }}" alt="AgriCulture" height="500">Yuk Rasain!
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel"
                ...
                <div class="carousel-item active">
                    <img src="{{ asset('build/assets/img/hero_1.jpg') }}" alt="">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('build/assets/img/hero_2.jpg') }}" alt="">
                    <div class="carousel-container">
                        <h2>Mak nyuss!!</h2>
                ...
                <div class="carousel-item">
                    <img src="{{ asset('build/assets/img/hero_3.jpg') }}" alt="">
                    <div class="carousel-container">
                        <h2>Jossss</h2>
                ...
                <div class="carousel-item">
                    <img src="{{ asset('build/assets/img/hero_4.jpg') }}" alt="">
                    <div class="carousel-container">
                        <h2>Nyaman Nongkrong</h2>
                ...
                <div class="carousel-item">
                    <img src="{{ asset('build/assets/img/hero_5.jpg') }}" alt="">
                    <div class="carousel-container">
                        <h2>Best Seller!!</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua.</p>
        ...
        <section id="services" class="services section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Pelayanan</h2>
                <p>Berbagai Pelayanan Yang Tersedia Pada Toko Yuk Rasain!</p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Tempat Keluarga</h3>
                                    <p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
                                        x="0" y="0" viewBox="0 0 514.314 514.314"
                                        style="enable-background: new 0 0 512 512" xml:space="preserve"
                                        class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Tempat Nongkrong Anak Muda</h3>
                                    <p>
                                        Gravida sodales condimentum pellen tesq accumsan orci quam
                                        sagittis sapie
                                    </p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
                                        x="0" y="0" viewBox="0 0 516.53 516.53"
                                        style="enable-background: new 0 0 512 512" xml:space="preserve"
                                        class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Tempat Nobar</h3>
                                    <p>
                                        Gravida sodales condimentum pellen tesq accumsan orci quam
                                        sagittis sapie
                                    </p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
                                        x="0" y="0" viewBox="0 0 509.389 509.389"
                                        style="enable-background: new 0 0 512 512" xml:space="preserve"
                                        class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Live Music</h3>
                                    <p>
                                        Gravida sodales condimentum pellen tesq accumsan orci quam
                                        sagittis sapie
                                    </p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
                                        x="0" y="0" viewBox="0 0 513.089 513.089"
                                        style="enable-background: new 0 0 512 512" xml:space="preserve"
                                        class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">View</h3>
                                    <p>
                                        Gravida sodales condimentum pellen tesq accumsan orci quam
                                        sagittis sapie
                                    </p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
                                        x="0" y="0" viewBox="0 0 511.67 511.67"
                                        style="enable-background: new 0 0 512 512" xml:space="preserve"
                                        class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Variant Menu</h3>
                                    <p>
                                        Gravida sodales condimentum pellen tesq accumsan orci quam
                                        sagittis sapie
                                    </p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
                                        x="0" y="0" viewBox="0 0 512.805 512.805"
                                        style="enable-background: new 0 0 512 512" xml:space="preserve"
                                        class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Fasilitas Olahraga</h3>
                                    <p>
                                        Gravida sodales condimentum pellen tesq accumsan orci quam
                                        sagittis sapie
                                    </p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <img src="{{ asset('build/assets/img/img_long_5.jpg') }}" alt="Image "
                                class="img-fluid img-overlap" data-aos="zoom-out">
                        </div>
                        <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                            <h3 class="content-subtitle text-white opacity-50">Kami Hadir dengan banyak Varian!</h3>
                            <h2 class="content-title mb-4">
                                Mampir Di <strong>Yuk Rasain! </strong> OK👌
                            </h2>
                            <p class="opacity-50">
                                Toko yang menyediakan menu sederhana namun terasa mewah di lidah, Kuyyyy!
                            </p>
            ...
            <div class="container">
                <div class="row gy-4 justify-content-between align-items-center">
                    <div class="col-lg-6 order-lg-2 position-relative" data-aos="zoom-out">
                        <img src="{{ asset('build/assets/img/img_sq_1.jpg') }}" alt="Image" class="img-fluid">
                        <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ" class="glightbox pulsating-play-btn">
                            <span class="play"><i class="bi bi-play-fill"></i></span>
                        </a>
                    </div>
                    <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                        <h2 class="content-title mb-4">Toko Sederhana tapi Tidak dengan Rasa!</h2>
                        <p class="mb-4">
                            Toko kami dibangun pada abad ke-1000 sebelum indo dijajah negara api. Kemudian setelah
                            merdeka, kami berkesmpatan membangun
                            sebuah toko sederhana tampak luar tetapi tampak dalam akan terasa nyaman. Toko kami juga
                            memiliki moto pantang pulang sebelum lidah senang
                        </p>
                        <ul class="list-unstyled list-check">
                            <li>Visi : Menjadikan Tempat Yang Nyaman Untuk Berkunjung</li>
                            <li>Misi : Membangun minat masyarakat dalam merasakan berbagai menu sederhana tetapi kaya
                                akan rasa</li>
                        </ul>
        ...
        <section id="recent-posts" class="recent-posts section">
            ...
            <!-- Section Title -->
            <div class="container section-title" data-aos="fade-up">
                <h2>Update Best Seller</h2>
                <p>Jangan lupa pantengin semua perubahannya!!</p>
            </div><!-- End Section Title -->
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('build/assets/img/blog/blog-1.jpg') }}" class="img-fluid"
                                    alt="">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('build/assets/img/blog/blog-2.jpg') }}" class="img-fluid"
                                    alt="">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="post-item position-relative h-100">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('build/assets/img/blog/blog-3.jpg') }}" class="img-fluid"
                                    alt="">
        ...
        <div class="copyright text-center">
            <div
                ...
                <div class="d-flex flex-column align-items-center align-items-lg-start">
                    ...
                    <div class="credits">
                        Designed by <a href="3">Evan Septya Utama</a>
                    </div>
                </div>
